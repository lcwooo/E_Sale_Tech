...
class SearchResultList extends StatefulWidget {
  final Map arguments;
  SearchResultList({this.arguments});
  @override
  _SearchResultListState createState() =>
      _SearchResultListState(arguments: arguments);
}

class _SearchResultListState extends State<SearchResultList> {
  final GlobalKey<_SearchResultListState> key = GlobalKey();
  final Map arguments;
  _SearchResultListState({this.arguments});
  int pageIndex = 0;
  ...
  loadMoreList() async {
    ...
    var data = await ApiSearch.getProductsList(params);
    return data;
  }
